object SKLottieEditorForm: TSKLottieEditorForm
  Left = 0
  Top = 0
  Caption = 'Lottie Editor'
  ClientHeight = 366
  ClientWidth = 490
  Color = clBtnFace
  ...
  object odgOpenDialog: TOpenDialog
    DefaultExt = 'json'
    Filter = 
      'All animated vectors (*.json;*.tgs)|*.json;*tgs|Lottie file (*.j' +
      'son)|*.json|Telegram sticker (*.tgs)|*.tgs'
    FilterIndex = 0
    Options = [ofHideReadOnly, ofPathMustExist, ofFileMustExist, ofEnableSizing]
    Title = 'Open animated vector'
    Left = 32
    Top = 8
  end
