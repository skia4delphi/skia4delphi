...
type
  ...
  public
    ...
    [TestCase('18',  'horse.webp,claRed,TileStretch,0.15,0.15,AllCorners,Round,False,0,0,1,1,0.4,0.98,/84AAMDScPP//vBgw9d+////93Pz33////////v///84wAgAAAAYGHgQ+BzzDPusX4//hP++/68')]
    ...
    [TestCase('66',  'horse.webp,claRed,TileStretch,0.15,0.15,AllCorners,Bevel,False,0,0,1,1,0.4,0.98,/8QAAEDQMMP//ODgQ9d+z///5/Nz33/P//////v///84wAgAAAAYGHgQ+BzzDPusX4//hP+//68')]
    ...
    [TestCase('90',  'horse.webp,claRed,TileStretch,0.15,0.15,AllCorners,InnerRound,False,0,0,1,1,0.4,0.98,78QAAAAAgMP//PDgw0fMz///9/PzT83P//////v//f84wAgAAAAYGHgQ+BzzDPusX4//hL+//68')]
    ...
    [TestCase('73',  '[claRed;0 claNull;0.5 claBlue;1],claWhite,Linear,0.15,0.15,AllCorners,InnerLine,0,0,1,1,0.85,0.98,gQD///9aAIG7OP///1sMjfs6////3y79//7////fLv0AAAAAAAAAAP///////////////z/8P/w')]
    ...
    [TestCase('77',  '[claRed;0 claNull;0.5 claBlue;1],claWhite,Linear,0.15,0.15,AllCorners,InnerLine,0.15,0.15,0.85,0.85,0.85,0.98,/8OB//+Bw///88H//4PP///7zf//z+////vP////7/9IEkACAAAgBD/8P/w//H/+P/wf+AgQAAA')]
    ...
    [TestCase('25',  'claPurple,claWhite,True,0.15,0.15,AllCorners,Bevel,0,0,1,1,0.85,0.98,w4EAAAAAgcP7seDAgwOFz/u95MSHB43v+//1769X3e+qVVQqqBVAAkACqBVUKqpVVCqqVdWralY')]
    ...
    [TestCase('49',  'claPurple,claWhite,True,0.15,0.15,AllCorners,InnerRound,0,0,1,1,0.85,0.98,w4EAAAAAgcP7ueDAQQKFz/u95MRFBo3v//337u/33/+//f///////////////7/9X/qv9VfqL/Q')]
    ...
    [TestCase('65',  'claPurple,claWhite,False,0.08,0.15,AllCorners,InnerRound,0,0,1,1,0.85,0.98,gYEAAAAAgYG7seBAAwONzbu95EQHB43vu/337q/X3/+//V/6//////////9f+r/9X/qr1VfqK9Q')]
    ...
    [TestCase('89',  'claPurple,claWhite,False,0.08,0.15,AllCorners,InnerLine,0,0,1,1,0.85,0.98,gYEAAAAAgYG7ueBAAwOFjbu95EQHB42vu/337q/X3/+//V/6//////////9f+r/9X/qr1VfqK9Q')]
