...
type
  ...
  public
    ...
    [TestCase('15.Long horizontal trailing', LongText + ',100,40,1,0,0,100,40,14,true,false,Trailing,Leading,Character,claBlack,3.83,0.38,103.83,38,0.97,/8CA+/8BIX///PD7/0dtf//99P//V39////////f/3/gAOAA/9///////v+smwCDBIMEoP////8')]
    ...
    [TestCase('17.Long horizontal center, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,false,Center,Center,Character,claBlack,0.58,1.57,99.42,39.19,0.97,/4GB//8BITn//fH//0dtff//////X219////////7f+AhYAFyYX///////+e/wSDhIMEgP////8')]
    [TestCase('18.Long horizontal trailing, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,false,Trailing,Center,Character,claBlack,3.83,1.57,103.83,39.19,0.97,/8CA+/8BIS3//PD7/0dtbf/99f//139t///////f/23gAOAA4EL/3/////+u/wCDBIMEgP////8')]
    ...
    [TestCase('21.Long horizontal trailing, vertical trailing', LongText + ',100,40,1,0,0,100,40,14,true,false,Trailing,Trailing,Character,claBlack,3.83,2.76,103.83,40.38,0.97,/+yAyfsJAQH//PDp+09NTf/89e37313P///////////gQOAA4AD/3//////+/wCDBIcEgkUi//8')]
    ...
    [TestCase('44.Long horizontal trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Leading,Character,claBlack,3.83,0.38,103.83,38,0.97,/8CA+/8BIX///PD7/0dtf//99P//V39////////f/3/gAOAA/9///////v+smwCDBIMEoP////8')]
    ...
    [TestCase('46.Long horizontal center, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,true,Center,Center,Character,claBlack,0.58,1.57,99.42,39.19,0.97,/4GB//8BITn//fH//0dtff//////X219////////7f+AhYAFyYX///////+e/wSDhIMEgP////8')]
    [TestCase('47.Long horizontal trailing, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Center,Character,claBlack,3.83,1.57,103.83,39.19,0.97,/8CA+/8BIS3//PD7/0dtbf/99f//139t///////f/23gAOAA4EL/3/////+u/wCDBIMEgP////8')]
    ...
    [TestCase('50.Long horizontal trailing, vertical trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Trailing,Character,claBlack,3.83,2.76,103.83,40.38,0.97,/+yAyfsJAQH//PDp+09NTf/89e37313P///////////gQOAA4AD/3//////+/wCDBIcEgkUi//8')]
