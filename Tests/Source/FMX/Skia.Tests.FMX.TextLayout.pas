...
type
  ...
  public
    ...
    [TestCase('42.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,98.84,38,0.97,/wMB//+AED////H//8be////+///z97/////////3v8CBwIH/v///////3/TlYAhgAEIgf////8')]
    [TestCase('43.Long horizontal center', LongText + ',100,40,1,0,0,100,40,14,true,true,Center,Leading,Character,claBlack,0.58,0.38,99.42,38,0.97,/4mB//+AkL///fH//8fc/////f//x97//////////v+YBYgF/7///////3/XtYAhgQFKCP////8')]
    [TestCase('44.Long horizontal trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Leading,Character,claBlack,3.83,0.38,103.83,38,0.97,/8CA+f+AkP///PD5/8fe///99v3/z97////////f/v/gEuAC/9///////3/DPsAgwUALKP////8')]
    [TestCase('45.Long vertical center', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Center,Character,claBlack,0,1.57,98.84,39.19,0.97,/wMB//+AEBP/f3H//8ZeX/9/9f//xt5f////////3n8CBwIHAg/////////X/4ABgAEAAf////8')]
    [TestCase('46.Long horizontal center, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,true,Center,Center,Character,claBlack,0.58,1.57,99.42,39.19,0.97,/4mB//+AkJP//fH//8fc3////f//x97f/////////t+AgYgFyIf/v//////Xf8AAgAEAAP////8')]
    [TestCase('47.Long horizontal trailing, vertical center', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Center,Character,claBlack,3.83,1.57,103.83,39.19,0.97,/8CA+f+AkJP//PD5/8fe2///9v3/797b/////////tvgAOAC4sL/3//////XfsEg0WgBAP////8')]
    [TestCase('48.Long vertical trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Trailing,Character,claBlack,0,2.76,98.84,40.38,0.97,/5MBI/eQEBD//3Fj99deXP///Xv3317e////////f/8CBwKHAgf+///////3f8CBgCEBAQqJ//8')]
    [TestCase('49.Long horizontal center, vertical trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Center,Trailing,Character,claBlack,0.58,2.76,99.42,40.38,0.97,/82Bmf+QkBD//fH5/9feXP/9//3/1978//////////+gAZgFyIX/v//////X/8EQgCEDAUoI//8')]
    [TestCase('50.Long horizontal trailing, vertical trailing', LongText + ',100,40,1,0,0,100,40,14,true,true,Leading,Trailing,Character,claBlack,3.83,2.76,103.83,40.38,0.97,/+iAyPuQkJD//PDp+9fe3P/89/37/979///////////gAOAS4AL/3///////f8EgwGCBQsss//8')]
    ...
    {$IFDEF TEXT_RENDER}
    [TestCase('1.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,-0.3,99.62,39,0,100000,10,False,claRed,0,1,10,True,claLime,1,0,10,True,claDeeppink,0.97,//+rAwP/hQD///vjw//NzP//++vz/+3d////6/////9nuwAAAAD/6O/w//AAAAAAKmZ/////AQA')]
    [TestCase('2.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.04,100,29,0,100000,10,False,claRed,0,1,10,True,claLime,1,1,12,True,claDeeppink,0.97,/ykAAKIg/////fDg4+b////98eD35/////3x4Pfn//9//zc7AAAAAH/zf/v//wAAAAAAAAAAAAA')]
    [TestCase('3.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,-0.29,100,30,0,100000,10,False,claRed,0,1,10,True,claLime,0,1,13,True,claDeeppink,0.97,/ykAAKIA/////fDg48f/////9eDj1//////14OPX//////87AAAAAAABf/93+5KqAAAAAAAAAAA')]
    [TestCase('4.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,-0.3,99.88,39,0,100000,10,False,claRed,0,2,10,True,claLime,0,1,10,True,claDeeppink,0.97,//srAwP/hQD///vjw//NyP//++vz/+3Z////6/////+3uwAAAAD/6O/w//AAAAAAe2Z/////EQA')]
    [TestCase('5.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,100,32,0,100000,10,False,claRed,0,0,10,True,claLime,0,1,14,True,claDeeppink,0.97,/ysA//8Aov//f3D//0fu////9f//d+7////1//937v//////BAAAAAAAAAF////7AAAAAAAAAAA')]
    ...
    [TestCase('9.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,1,14,True,claLime,1,0,10,True,claDeeppink,0.97,/wMDh78Auf////Pn/8b/////+/f/zv////////////8AHwAf/v////////////////////////8')]
    [TestCase('10.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,0,14,True,claLime,1,0,10,True,claDeeppink,0.97,/wMDh78Auf////Pn/8b/////+/f/zv////////////8CHwIf/v/+//////////////////////8')]
    [TestCase('11.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,1,14,True,claLime,0,0,10,True,claDeeppink,0.97,/wMDh78Auf////Pn/8b/////+/f/zv////////////8AHwAf/v////////////////////////8')]
    [TestCase('12.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,1,14,True,claLime,0,1,10,True,claDeeppink,0.97,/wMDB78Auf////Pn/8b9////+/f/zv////////////8AH4Af/v/+//////////////////////8')]
    [TestCase('13.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,1,14,True,claLime,1,1,10,True,claDeeppink,0.97,/wMDh78Auf////Pn/8b9////+/f/zv////////////9AP0Af/v////////////////////////8')]
    [TestCase('14.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,1,14,True,claLime,3,3,10,True,claDeeppink,0.97,/wMDp78Auf////Pn/8b/////++f/zv////////////8cPxw//f////////////////////////8')]
    [TestCase('15.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,1,1,14,True,claLime,2,1,10,True,claDeeppink,0.97,/4MDh78Auf///3Pn/0f/////+/f/z/////////////8CHwIf/v////////////////////////8')]
    [TestCase('16.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,1,1,14,True,claLime,3,0,10,True,claDeeppink,0.97,/wMDh78Auf////Pn/8b/////+/f/zv////////////8AHwAf/v////////////////////////8')]
    [TestCase('17.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,99.15,35,10,100000,12,False,claRed,0,10,14,True,claLime,1,9,10,True,claDeeppink,0.97,/4UA//8AzP///XD//0fO/////P//787////8////zv9//j/+AgAAAAAAIQJv/3////8AAAAAAAA')]
    [TestCase('18.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,100,35,10,100000,12,False,claRed,0,11,14,True,claLime,1,9,10,True,claDeeppink,0.97,/4UA//8AyP///XD//0fO///99v//787///////////9/H38f//////////////////////////8')]
    [TestCase('19.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.29,35,10,100000,12,False,claRed,0,10,14,True,claLime,8,4,10,True,claDeeppink,0.97,//MB878Agf///3Hz/0fP//////v/z8//////////z/8APwB//3//f/////////////////////8')]
    [TestCase('20.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,100,35,10,100000,12,False,claRed,0,11,14,True,claLime,1,9,10,True,claDeeppink,0.97,/4UA//8AyP///XD//0fO///99v//787///////////9/H38f//////////////////////////8')]
    [TestCase('21.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,97.97,35,10,100000,12,False,claRed,0,11,14,True,claLime,1,10,10,True,claDeeppink,0.97,/4EA//8AzP///XD//0fO///9/P//787///38////zv9//j/+AgAAAAAAIQJv/3////8AAAAAAAA')]
    [TestCase('22.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,99.84,35,10,100000,12,False,claRed,0,11,14,True,claLime,1,11,10,True,claDeeppink,0.97,/4EA//8AzP///XD//0fO///99P//787///30////zv9//j/+AgAAAAAAIQJv/3////8AAAAAAAA')]
    [TestCase('23.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,100,35,10,100000,12,False,claRed,3,8,14,True,claLime,1,9,10,True,claDeeppink,0.97,/w0A//8AzP//fXD//0fO//9/dv//787///////////9/H38f//////////////////////////8')]
    [TestCase('24.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,99.76,38,10,8,12,False,claRed,11,3,14,True,claLime,13,3,10,True,claDeeppink,0.97,/wMDt/+AgP////P3/8bO////+/f/9u7/////////7v+CnwIf/v//////3//fa5xCnpIdEv////8')]
    [TestCase('25.Long horizontal leading', LongText + ',100,40,1,0,0,100,40,14,true,true,Trailing,Leading,Character,claBlack,0,0.38,100,38,10,10,12,False,claRed,11,6,14,True,claLime,12,2,10,True,claDeeppink,0.97,/wMDt/+AsH////P3/8b+////+/f/9v7//////////v/CnwIf////////7//pfeFE48Pj2P////8')]
    {$ENDIF}
