...
type
  ...
  private
    procedure TestRender(const ASvgFileName: string; const AWidth, AHeight: Integer; const AWrapMode: TSkSvgWrapMode; const AOverrideColor: TAlphaColor; const AExpectedImageHexHash: string);
  protected
  ...
  public
    ...
    procedure TestFitRender(const ASvgFileName: string; const AWidth, AHeight: Integer; const AExpectedImageHexHash: string);
    ...
    procedure TestTileRender(const ASvgFileName: string; const AWidth, AHeight: Integer; const AExpectedImageHexHash: string);
    ...
    procedure TestDefaultRenderWithACustomColor(const ASvgFileName: string; const AWidth, AHeight: Integer; const AExpectedImageHexHash: string);
  end;
...
procedure TSkSvgBrushTests.TestDefaultRenderWithACustomColor(
  ...
  const AExpectedImageHexHash: string);
begin
  TestRender(ASvgFileName, AWidth, AHeight, TSkSvgWrapMode.Default, TAlphaColors.Blueviolet, AExpectedImageHexHash);
end;

procedure TSkSvgBrushTests.TestFitRender(const ASvgFileName: string;
  const AWidth, AHeight: Integer; const AExpectedImageHexHash: string);
begin
  TestRender(ASvgFileName, AWidth, AHeight, TSkSvgWrapMode.Fit, TAlphaColors.Null, AExpectedImageHexHash);
end;
...
procedure TSkSvgBrushTests.TestRender(const ASvgFileName: string;
  ...
  const AOverrideColor: TAlphaColor; const AExpectedImageHexHash: string);
var
  LSurface: ISkSurface;
  LBrush: TSkSvgBrush;
begin
  ...
  Assert.AreSimilar(AExpectedImageHexHash, LSurface.MakeImageSnapshot);
end;

procedure TSkSvgBrushTests.TestTileRender(const ASvgFileName: string;
  const AWidth, AHeight: Integer; const AExpectedImageHexHash: string);
begin
  TestRender(ASvgFileName, AWidth, AHeight, TSkSvgWrapMode.Tile, TAlphaColors.Null, AExpectedImageHexHash);
end;
