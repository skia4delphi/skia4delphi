...
{   cmd /C ""Skia4Delphi_3.3.1_Setup.exe" /DIR="C:\Skia4Delphi" /SILENT  }
{     /RADStudioVersions=all"                                            }
{                                                                        }
{ In GetIt implementation, the installation command could be:            }
{   cmd /C ""$(BDSCatalogRepository)\Skia4Delphi-3.3.1\                  }
{     Skia4Delphi_3.3.1_Setup.exe"                                       }
{     /DIR="$(BDSCatalogRepository)\Skia4Delphi-3.3.1" /VERYSILENT       }
...
{   cmd /C ""$(BDSCatalogRepository)\Skia4Delphi-3.3.1\unins000.exe"     }
{     /VERYSILENT /RADStudioVersions=$(ProductVersion)"                  }
{                                                                        }
{************************************************************************}

#define LibraryName "Skia4Delphi"
#define LibraryVersion "3.3.1"
