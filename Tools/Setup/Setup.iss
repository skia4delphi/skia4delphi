...
{   cmd /C ""Skia4Delphi_6.3.0_Setup.exe" /DIR="C:\Skia4Delphi" /SILENT  }
{     /RADStudioVersions=all"                                            }
{                                                                        }
{ In GetIt implementation, the installation command could be:            }
{   cmd /C ""$(BDSCatalogRepository)\Skia4Delphi-6.3.0\                  }
{     Skia4Delphi_6.3.0_Setup.exe"                                       }
{     /DIR="$(BDSCatalogRepository)\Skia4Delphi-6.3.0" /VERYSILENT       }
...
{   cmd /C ""$(BDSCatalogRepository)\Skia4Delphi-6.3.0\unins000.exe"     }
{     /VERYSILENT /RADStudioVersions=$(ProductVersion)"                  }
{                                                                        }
{************************************************************************}

#define LibraryName "Skia4Delphi"
#define LibraryVersion "6.3.0"
